namespace SimpleShop.Models.Commands.DeleteCommands
{
    ...
    /// </summary>
    public class OpenOrderDeleteMenuCommand : CommandBase
    {
        private readonly NavigationService _navigationService;
        private readonly Func<ViewModelBase> _createNewViewModel;
        public OpenOrderDeleteMenuCommand(NavigationService navigationService, Func<ViewModelBase> createNewViewModel)
        {
